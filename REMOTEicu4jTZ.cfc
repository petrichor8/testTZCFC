...
date:		27-mar-2006
revisions:	30-mar-2006 added 1 methods (getServerTZShort) contributed by dan switzer: 
			dswitzer@pengoworks.com
			21-apr-2007	swapped to using mark mandel's javaloader CFC
...
<!--- modify this method to pont to where you stored the javaLoader CFC & icu4j jar --->
<cffunction access="public" name="init" output="No" hint="initializes needed classes">
<cfargument name="icu4jJarFile" required="no" type="string" default="c:\JRun4\servers\cfusion\cfusion-ear\cfusion-war\WEB-INF\lib\icu4j-3_6.jar">
<cfscript>
	var paths=listToArray(arguments.icu4jJarFile);
	// modify to point to where you placed javaLoader CFC
	var javaLoader=createObject("component","cfc.javaLoader").init(paths);
	variables.timeZone=javaLoader.create("com.ibm.icu.util.TimeZone");
	return this;
</cfscript>
</cffunction>
